    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                bota uma senha namoral ai rapaziada não vai colocar senha fraca não
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="password" value="Senha nova" />
            ...
            <div>
                <InputLabel for="password_confirmation" value="Confirme a senha nova" />
